export KALDI_ROOT=/export/tools/kaldi-trunk3/
...
export LC_ALL=C
export IRSTLM=$KALDI_ROOT/tools/irstlmi
export LD_LIBRARY_PATH=/usr/local/lib:/export/tools/sphinx/lib/:/usr/lib64/:/scratch2/nxs113020/lib/:/export/lib/
